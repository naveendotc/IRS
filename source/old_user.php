<?php include("header.php"); include("constants.php"); ?>
  ...
  <script type="text/javascript">
    function validate()
    {
      ...
      if(document.getElementById("select_elem").value == "Select type of issue")
      {
  ...
  <body>
      ...
      <div class="container">
        <div class="col-md-2">
          <ul class="nav nav-stacked">
            <li><button type="button" class="btn btn-primary" id="issue_btn">
              Raise Issue
            </button>
            </li>
            <?php 
              $uid = $_COOKIE['uid'];
              $query = "select previleges from users where user_id = '$uid'";
                      ...
                      {
                        $previlege = $row[0];
                        if($previlege == 0) // user only
                        {
                          //echo("<li role='presentation'><a href='#'>Request for solver previleges</a></li>");
                          echo("<li><button type='button' class='btn btn-primary' id='request_prev'>
                                Request for solver previleges
                                </button></li>");
                        }
                        else
                        {
        ...
        <div class="col-md-10"><h2>Raise an issue by clicking here</h2> 
            ...
            <div id="raise_issue" style="display:none">
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title"><center>Raise Issue</center></h3>
                </div>
                <div class="panel-body">
                  <form action="user.php" method="post" onsubmit="return validate()">
                    <input type="text" id="subject" class="form-control" placeholder="Subject(atmost one line)" name="subject" style="width:490px" required>
                    <br>
                    <select class="selectpicker;btn btn-primary" name="issue_type" id = "select_elem">
                    ...
                    <br>
                    <br>
                    <textarea class="form-control" name="description" id="textarea" style="width:490px; height:150px;" placeholder="Comments .." required></textarea>
                    <br>
                    <div align="center">
    ...
    <div class="row" id="row2">
      ...
      <div class="row" id="row4" style="display:none">
          ...
          <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title"><center>Request for Solver Previleges</center></h3>
                </div>
                <div class="panel-body">
